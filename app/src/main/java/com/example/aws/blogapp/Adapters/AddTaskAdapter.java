...
import com.example.aws.blogapp.Activities.AddTaskActivity;
...
public class AddTaskAdapter extends RecyclerView.Adapter<AddTaskAdapter.MyViewHolder> {
    ...
    public AddTaskAdapter(Context mContext, List<Post> mData) {
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent postDetailActivity = new Intent(mContext, AddTaskActivity.class);
